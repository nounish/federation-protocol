...
import { NounsPool } from "src/module/governance-pool/Nouns.sol";
import { FactValidator } from "src/module/governance-pool/FactValidator.sol";
...
contract Deploy is Script {
  ...
  function run() external {
    ...
    NounsFactory factory =
    new NounsFactory(address(impl), reliquary, DELEGATE_CASH, address(fv), feeRecipient, feeBPS, maxBasefeeRefund, useStartBlockFromPropId);
