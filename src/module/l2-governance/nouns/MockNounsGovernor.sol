...
/**
 * @title Mock Nouns Governor
 * @notice For testing the Nouns Governor without L1 -> L2 communication
 */
contract MockNounsGovernor is Governor {
    ...
    */
    function settleVotes(uint256 _proposal, bytes calldata _blockProof) external payable refundGas returns (Message memory) {
