...
contract TestMath is NounsPool, Test {
  ...
  function testBPSToUint() public {
    ...
    assertEq(_bpsToUint(10000 - bps, proceeds) + _bpsToUint(bps, proceeds), proceeds);
    ...
    uint256 sumRatios = _bpsToUint(r1, proceeds) + _bpsToUint(r2, proceeds)
      + _bpsToUint(r3, proceeds) + _bpsToUint(r4, proceeds) + _bpsToUint(r5, proceeds);
